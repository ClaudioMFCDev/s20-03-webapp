 ...
 *
 * This component renders a footer with the ClassRun logo, a list of navigation
 * links, social media icons, and a copyright notice. The navigation links and
 * social media icons are dynamically generated based on predefined constants.
 * The component is responsive and adjusts its layout for different screen sizes.
 */

export const FooterLanding = () => {
  return (
    <footer className="w-full border-t py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <span className="block text-center text-sm text-gray-500">
            © {new Date().getFullYear()} ClassRun. Todos los derechos
            reservados.
          </span>
        </div>
      </div>
